...
public class WsServidor extends WebSocketServer {
    ...
    public void onOpen(WebSocket conn, ClientHandshake handshake) {
        ...
        conn.send("Benvingut a WsServer id="+getConnectionId(conn));
    ...
    public void onMessage(WebSocket conn, String message) {
        ...
        if (message.equalsIgnoreCase("list")) {
            ...
            String posJson = null;
            try {
                PosMessage pos = mapper.readValue(message,PosMessage.class);
                pos.id = getConnectionId(conn);
                posJson = mapper.writeValueAsString(pos);
                broadcast(posJson);
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            if( posJson!=null )
                System.out.println("Broadcast de " + getConnectionId(conn) + ": " + posJson);
            else
